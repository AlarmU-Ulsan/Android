...
import com.uou.alarmit.CollegesList.College
import com.uou.alarmit.CollegesList.collegesList
import com.uou.alarmit.databinding.ActivityFirstAlarmChoiceBinding
import com.uou.alarmit.databinding.ItemAlarmChoiceBinding
import com.uou.alarmit.databinding.ItemAlarmChoiceCollegeBinding
                ...
                inner class ViewHolder(private val majorBinding: ItemAlarmChoiceBinding): RecyclerView.ViewHolder(majorBinding.root) {
                    fun bind(major: CollegesList.Major) {
                        ...
                        majorBinding.root.setOnClickListener {
                            ...
                            syncAlarmSubscription(this@FirstAlarmChoiceActivity, previousMajor, setting.alarmMajor)
